...
namespace WindowsFormsApplication1 {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class UtilizatoriDataTable : global::System.Data.TypedTableBase<UtilizatoriRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UtilizatoriRow AddUtilizatoriRow(string Nume, string Email, string Parola) {
...
namespace WindowsFormsApplication1.DatabaseDataSetTableAdapters {
    ...
    public partial class UtilizatoriTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Utilizatori] WHERE (([IdUtilizator] = @Original_IdUtilizator) AND ((@IsNull_Nume = 1 AND [Nume] IS NULL) OR ([Nume] = @Original_Nume)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Parola = 1 AND [Parola] IS NULL) OR ([Parola] = @Original_Parola)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Utilizatori] ([Nume], [Email], [Parola]) VALUES (@Nume, @Email" +
                ", @Parola);\r\nSELECT IdUtilizator, Nume, Email, Parola FROM Utilizatori WHERE (Id" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Utilizatori] SET [Nume] = @Nume, [Email] = @Email, [Parola] = @Parola WHERE (([IdUtilizator] = @Original_IdUtilizator) AND ((@IsNull_Nume = 1 AND [Nume] IS NULL) OR ([Nume] = @Original_Nume)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Parola = 1 AND [Parola] IS NULL) OR ([Parola] = @Original_Parola)));
SELECT IdUtilizator, Nume, Email, Parola FROM Utilizatori WHERE (IdUtilizator = @IdUtilizator)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdUtilizator, Nume, Email, Parola FROM dbo.Utilizatori";
        ...
        public virtual int Delete(int Original_IdUtilizator, string Original_Nume, string Original_Email, string Original_Parola) {
        ...
        public virtual int Update(string Nume, string Email, string Parola, int Original_IdUtilizator, string Original_Nume, string Original_Email, string Original_Parola, int IdUtilizator) {
            if ((Nume == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nume, string Email, string Parola, int Original_IdUtilizator, string Original_Nume, string Original_Email, string Original_Parola) {
            return this.Update(Nume, Email, Parola, Original_IdUtilizator, Original_Nume, Original_Email, Original_Parola, Original_IdUtilizator);
        }
    }
